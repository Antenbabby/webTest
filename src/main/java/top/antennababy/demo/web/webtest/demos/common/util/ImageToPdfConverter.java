...
public class ImageToPdfConverter {
    ...
    public static void main(String[] args) throws IOException {
        String imgFilePath = "d:\\temp\\aaa.jpg";
        String pdfFilePath = "d:\\temp\\aaa.pdf";
        image2Pdf(imgFilePath, pdfFilePath);
    }
     ...
     */
    public static void image2Pdf(String imgFilePath, String filePath) {
        try {
            // 1.将本地的图片转成流形式
