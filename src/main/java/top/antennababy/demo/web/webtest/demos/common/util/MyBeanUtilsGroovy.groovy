...
class MyBeanUtilsGroovy {
     ...
     */
    static <T> T mapToObj(Map source, Class<T> target) {
        try {
     ...
     * @param target 目标对象
     */
     static def copySelective(Object source, Object target) {
     ...
     * @return
     */
    static JSONObject parseJsonObj(String str) {
    ...
    static JSONObject parseJsonObj(JSONObject jsonObject) {
    ...
    public static<T> T filterObjHtml(T obj) {
        try {
            ...
            if (obj instanceof Map) {
                ...
                obj = (T) BeanUtil.toBeanIgnoreError(filterObjHtml(map), obj.getClass());
            }
        } catch (Exception e) {
